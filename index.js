...
FileServer.prototype.serveFile = function(fileName, mimeType = 'text/plain', maxAge = 0, _suppressWatcher = false) {
    ...
    // Bolt ⚡: To avoid creating a watcher for every file, this is now suppressed
    // when serving a directory, which has its own watcher.
...
FileServer.prototype.serveDirectory = function(rootDirectory, mimeTypes, maxAge = 0) {
    ...
    // Bolt ⚡: Create one watcher per directory instead of one per file to improve performance.
