...
FileServer.prototype.serveFile = function(fileName, mimeType = 'text/plain', maxAge = 0, _suppressWatcher) {
    ...
    // Bolt ⚡: Create a watcher only when `serveFile` is called directly, not from `serveDirectory`.
    // This prevents creating a redundant watcher for each file when a directory watcher already exists.
